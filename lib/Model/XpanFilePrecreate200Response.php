...
/**
 * XpanFilePrecreate200Response Class Doc Comment
 *
 * @category Class
 * @package  Clainy\OpenxpanApiClient
 * @author   OpenAPI Generator team
 ...
 */
class XpanFilePrecreate200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'XpanFilePrecreate_200_response';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['block_list'] === null) {
            $invalidProperties[] = "'block_list' can't be null";
        }
     ...
     * Sets uploadid
     *
     * @param string $uploadid 上传唯一ID标识此上传任务
     *
     * @return self
     */
     ...
     * Sets return_type
     *
     * @param int $return_type 返回类型，系统内部状态字段
     *
     * @return self
     */
     ...
     * Sets block_list
     *
     * @param string[] $block_list 需要上传的分片序号列表，索引从0开始
     *
     * @return self
     */
