<?php
/**
 * XpanMultimediaFilemetas200Response
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * XpanMultimediaFilemetas200Response Class Doc Comment
 *
 * @category Class
 * @package  Clainy\OpenxpanApiClient
 * @author   OpenAPI Generator team
 ...
 */
class XpanMultimediaFilemetas200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'XpanMultimediaFilemetas_200_response';
    ...
    */
     ...
     * Sets names
     *
     * @param string[] $names 如果查询共享目录，该字段为共享目录文件上传者的uk和账户名称
     *
     * @return self
     */
